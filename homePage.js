document.addEventListener("DOMContentLoaded", () => {
	...
	fetch( "../PostServlet?source=homePage" ).then( response => response.json() ).then( data => {
			...
			data.forEach( (post, index) => {
				...
				postDiv.innerHTML = `
					...
					<a href="../AccountServlet?source=homePage&clickedUser=${post.accountUsername}&target=userPage" class="main-profile-img-link">
